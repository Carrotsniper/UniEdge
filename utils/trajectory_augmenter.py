...
class TrajectoryAugmenter():
    ...
    def _aug_nodes(self,
        ...
        for i in range(
            ...
            obs_traj, pred_traj_gt, obs_traj_rel, pred_traj_gt_rel, non_linear_ped, loss_mask, V_obs_, V_tr_ = next(
    ...
    def _aug_rot(self, obs_traj, pred_traj_gt):
        ...
        full_traj = torch.cat((obs_traj.double(), pred_traj_gt.double()), dim=-1)
